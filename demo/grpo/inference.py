...
from train import setup_tokenizer_and_model
...
def load_model(checkpoint_dir, configs, device):
    ...
    """
    (
        model, tokenizer, latent_id, start_id, end_id, _, _,
    ...
    # Load trained weights into base_causallm
...
def save_results(result, output_dir, idx=0):
...
def main():
    ...
    for i, text in enumerate(texts):
        ...
        save_results(result, args.output, idx=i)
