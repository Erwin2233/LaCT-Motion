...
用于将连续的 motion pose 序列编码为离散 token，以及解码回 pose 序列。
"""

import torch.nn as nn
from third_party.trl_motion.t2m.models.encdec import Encoder, Decoder
from third_party.trl_motion.t2m.models.quantize_cnn import QuantizeEMAReset, Quantizer, QuantizeEMA, QuantizeReset
